export const complaintSections = [
  ...
  { title: 'Initial assessment & priority', fields: [['initialSeverity', 'Initial severity', 'select', ['Low', 'Moderate', 'High', 'Critical']], ['priority', 'Priority', 'select', ['Low', 'Medium', 'High', 'Critical']]] }
]
